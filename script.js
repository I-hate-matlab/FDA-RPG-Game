...
const submissionInfo = {
  'Device': { 'Exempt': 'No bonus (0%)', '510(k)': 'Funding bonus: 5%', 'PMA': 'Funding bonus: 10%' },
  'Drug': { 'NDA': 'Funding bonus: 5%', 'ANDA': 'No bonus (0%)' },
  'Biologic': { 'BLA': 'No bonus (0%)' }
};
const bonusPercentages = { 'Exempt': 0, '510(k)': 5, 'PMA': 10, 'NDA': 5, 'ANDA': 0, 'BLA': 0 };
